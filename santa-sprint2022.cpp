...
{ 
    ...
    // non consistent hazard variables outside the for loop (I went for 10 here but noting that it goes up to 9 as we start from 0)
    ...
    while(!WindowShouldClose()) //allows user to exit upon escape button and end below while loop
        {	
            ...
            // draw signature
            DrawText("SANTA SPRINT 2022", 10, 10, 20, RED);
            ...
            if (collision) // if statement for when collision variable is activated
            {
                ...
                /* In this section I tried to problem solve a way to restart the game. The logic here was that I need to reset all the functions and variables (ie - santa hazard collision off, finish line reset to zero and game start to zero - however this was not enough so I removed this BUT I will return to resolve one day! Leaving in here so you seem my issue and attempts)
                // restart the game
